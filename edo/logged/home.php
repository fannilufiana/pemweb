...
<head>
	<title>Monseour Restaurant</title>
	<!-- required meta tags -->
	<meta charset="utf-8">
...
<header class="w3-display-container w3-content w3-wide" style="max-width:1600px;min-width:500px;" id="home">
  <img class="w3-image" src="https://thumbor.forbes.com/thumbor/960x0/https%3A%2F%2Fblogs-images.forbes.com%2Ftarandipkaur%2Ffiles%2F2017%2F12%2FRISE-Festive-Menu-1200x1200.jpg" alt="Luxury Dish" width="1600" height="800">
  <div class="w3-display-bottomleft w3-padding-large w3-opacity">
    <h1 class="w3-xxlarge">Monseour Restaurant</h1>
  </div>
</header>
